...
export default {
  ...
  data () {
    return {
        columns: [
          {name: 'Nombre de boss tués', label: 'Nombre de boss tués', field: 'bossKills', sortable: true, align: 'left'},
          {name: 'PVE Deaths', label: 'PVE Deaths', field: 'deathsPvE', sortable: true, align: 'left'},
